...
QT_MOC_LITERAL(1, 8, 11), // "cardScanned"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "cardID"
QT_MOC_LITERAL(4, 28, 11) // "onReadyRead"

    },
    "Arduino\0cardScanned\0\0cardID\0onReadyRead"
};
...
void Arduino::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cardScanned((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Arduino::cardScanned)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Arduino::cardScanned(const QString & _t1)
{
